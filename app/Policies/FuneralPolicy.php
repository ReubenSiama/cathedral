...
class FuneralPolicy
{
    ...
    {
        return $user->can('view_any_funeral');
    }
    ...
    {
        return $user->can('create_funeral');
    }
    ...
    {
        return $user->can('update_funeral');
    }
    ...
    {
        return $user->can('delete_funeral');
    }
    ...
    {
        return $user->can('delete_any_funeral');
    }
