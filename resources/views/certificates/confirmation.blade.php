...
<head>
    ...
    <title>{{ $confirmation->name }} {{ $confirmation->surname }}</title>
    <style>
        @page{
            margin: 0;
        }
...
<body>
    <table class="first-table">
        ...
        <tr>
            ...
            <td colspan="4" class="underline">{{ $confirmation->name }} {{ $confirmation->surname }}</td>
        </tr>
        <tr>
            <td>Date of Birth</td>
            <td colspan="2" class="width-1 text-right">:</td>
        ...
        <tr>
            ...
            <td colspan="4" class="underline">
                {{ $confirmation->father_name }} {{ $confirmation->father_surname }}
            </td>
        </tr>
        <tr>
            <td>Mother's Name</td>
            <td colspan="2" class="width-1 text-right">:</td>
            <td colspan="4" class="underline">
                {{ $confirmation->mother_name }} {{ $confirmation->mother_surname }}
            </td>
        </tr>
        <tr>
            <td>Address</td>
    ...
    <table class="second-table">
        <tr>
            ...
            <td style="width: 1%;">:</td>
            <td class="underline" style="width: 25%">Cathedral, Aizawl</td>
        ...
        <tr>
            <td>Date of Issue</td>
            <td style="width: 1%;">:</td>
            <td class="underline">{{ date('d/m/Y', strtotime($confirmation->date_of_issue)) }}</td>
            <td colspan="2" class="underline"></td>
        </tr>
        <tr>
            <td>Reg. No.</td>
            <td style="width: 1%;">:</td>
            <td class="underline">{{ $confirmation->number }}</td>
