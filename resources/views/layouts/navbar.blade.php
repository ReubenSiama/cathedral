  ...
  <div class="container flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      ...
      md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li>
          <a href="#" class="{{ Route::is('clergy') ? $activeClass : $inactiveClass }}">Clergy & Religious</a>
        </li>
        <li>
          <a href="#" class="{{ Route::is('ppc') ? $activeClass : $inactiveClass }}">Parish Pastoral Council</a>
        </li>
        <li>
          <a href="#" class="{{ Route::is('associations') ? $activeClass : $inactiveClass }}">Associations</a>
        </li>
        <li>
          <a href="{{ route('gallery') }}" class="{{ Route::is('gallery') ? $activeClass : $inactiveClass }}">Gallery</a>
        </li>
        <li>
